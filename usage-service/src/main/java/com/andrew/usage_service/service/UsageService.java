package com.andrew.usage_service.service;

import com.andrew.kafka.event.AlertingEvent;
import com.andrew.kafka.event.EnergyUsageEvent;
import com.andrew.usage_service.client.DeviceClient;
import com.andrew.usage_service.client.UserClient;
import com.andrew.usage_service.dto.DeviceDto;
import com.andrew.usage_service.dto.UsageDto;
import com.andrew.usage_service.dto.UserDto;
import com.andrew.usage_service.entity.Device;
import com.andrew.usage_service.entity.DeviceEnergy;
...
public class UsageService {
    ...
    public UsageDto getXDaysUsageForUser(Long userId, int days) {
        ...
        final List<DeviceDto> devicesDto = deviceClient.getDevicesByUserId(userId);
